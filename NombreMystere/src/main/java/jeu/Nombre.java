...
public class Nombre {
	...
	//D�claration de l'attribut listChiffres en priv� de notre objet.
	...
	//Get de l'attribut listChiffres pour pouvoir acc�der a ses valeurs
	...
	//Fonction permettant � l'ordinateur de choisir un nombre par rapport au r�sultat
	...
	public int Mode1(Nombre a) {
		...
		if (count == 10) {
			System.out.println("Dommage vous avez perdu. Le nombre �tait : " + a.toString());
		} else {
	...
	public void Mode2(Nombre a) {
		...
		if (count == 10) {
			...
			System.out.println("L'ordinateur a gagn� en " + count + " essais !");
		}
	}
}
